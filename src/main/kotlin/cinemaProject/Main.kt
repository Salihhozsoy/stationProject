...
fun main() {
    ...
    val userOguz = User(1, "Ouzo", "SinemaSever")
    ...
    val movie = Movie(1, "Oppenheimer", 140.0, LocalDate.of(2023, 7, 21), Database.actors, duration = 135523234)
    val theatre = Theatre(1, "Romeo & Juliet", 100.0, LocalDate.of(2023, 9, 10), Database.actors, stageCount = 6)
