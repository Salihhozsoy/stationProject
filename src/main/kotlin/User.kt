class User() {
    ...
    constructor(id:Int, name:String, surname:String, email:String, password:String) : this(){   //ilk const kullanılmadığı için ikinci constu bu şekilde kullanıyoruz this ile
        this.id = id
        this.email = email
...
fun main() {
    ...
    animal.name = "Tekir"
    println("${animal.type} hayvani ${animal.calculateSpeed()} kadar hizli hareket eder ve ismi ${animal.name} dir.")
